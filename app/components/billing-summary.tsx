...
export function BillingSummary({ cart, total, onRemoveItem, onClearCart, onAddIncrement }: BillingSummaryProps) {
  return (
    <div className="w-[400px] bg-white border-l border-[#e9ecef] flex flex-col">
      {/* Header */}
      ...
      <div className="p-6 border-t border-[#e9ecef] bg-[#f8f9fa]">
        <div className="mb-4">
          <div className="flex items-baseline justify-between mb-2">
            ...
            <span className="text-[#495057]">AED {total.toFixed(2)}</span>
          </div>
